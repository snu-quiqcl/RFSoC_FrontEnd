...
s2pA = snp2smp(sparams_3p,[2 3 1]); % reorder port 
...
s_cascade = cascadesparams(s2pA_interp, s2pB_interp, s2pC_interp,s2pF_interp);
...
nexttile
plot(freq, 20*log10(abs(s11)),LineWidth=0.8);
title('S11 magnitude');
xlabel('Frequency (Hz)');
ylabel('Magnitude (dB)');

nexttile
plot(freq, angle(s11).*180./pi,LineWidth=0.8, Color='r');
title('S11 phase');
xlabel('Frequency (Hz)');
ylabel('Magnitude (dB)');
%% S21
nexttile
plot(freq, 20*log10(abs(s21)),LineWidth=0.8);
title('S21 magnitude');
xlabel('Frequency (Hz)');
ylabel('Magnitude (dB)');

nexttile
plot(freq, angle(s21).*180./pi,LineWidth=0.8, Color='r');
title('S21 phase');
xlabel('Frequency (Hz)');
ylabel('Magnitude (dB)');
...
%% S12
nexttile
plot(freq, 20*log10(abs(s12)),LineWidth=0.8);
title('S12 magnitude');
xlabel('Frequency (Hz)');
ylabel('Magnitude (dB)');

nexttile
plot(freq, angle(s12).*180./pi,LineWidth=0.8, Color='r');
title('S12 phase');
xlabel('Frequency (Hz)');
ylabel('Magnitude (dB)');
%% S22
nexttile
plot(freq, 20*log10(abs(s22)),LineWidth=0.8);
title('S22 magnitude');
xlabel('Frequency (Hz)');
ylabel('Magnitude (dB)');

nexttile
plot(freq, angle(s22).*180./pi,LineWidth=0.8, Color='r');
title('S22 phase');
xlabel('Frequency (Hz)');
ylabel('Magnitude (dB)');
%%
